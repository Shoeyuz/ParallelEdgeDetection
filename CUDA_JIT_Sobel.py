...
#cuda assigning of GPU processing to the function
#compiler automatically assigns the cores throughout 
@jit
def sobelFilter(a):
...
if __name__=='__main__':
    img = cv2.imread('/content/flower.jpg', cv2.COLOR_BGR2GRAY)
